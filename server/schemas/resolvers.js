...
const { Profile, Recipe, Product } = require('../models');
...
const resolvers = {
  ...
  Mutation: {
    ...
    addProduct: async (parent, { product: {name, quantity, oum, refrigerated} }) => {

      const product = await Product.create({  name, quantity, oum, refrigerated  });
